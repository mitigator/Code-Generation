...
// function EntityCard({ entity, selected, onToggleSelection, index, colors }) {
...
//         border: selected ? `1px solid ${colors.primary}` : `1px solid ${colors.borderDefault}`
//       }}
//     >
//       <div 
...
//           />
//           <h3 className="text-lg leading-6 font-medium" style={{ color: colors.textPrimary }}>
//             {entityName}
//           </h3>
//         </div>
//         <div 
...
//           style={{ 
//             backgroundColor: expanded ? `${colors.primary}15` : `${colors.textLight}15`,
...
//             <span className="font-medium" style={{ color: colors.textPrimary }}>Description:</span> {entityDescription}
//           </p>
          
//           <div className="flex items-center mb-2">
//             <h4 className="text-sm font-medium" style={{ color: colors.textPrimary }}>Fields</h4>
//             <span 
